...
class HeapTests: XCTestCase {
  public func verifyMaxHeap(_ h: Heap<Int>) -> Bool {
    for i in 0..<h.count {
      let left = h.leftChildIdx(ofIdx: i)
      let right = h.rightChildIdx(ofIdx: i)
      let parent = h.parentIdx(ofIdx: i)
  ...
  public func verifyMinHeap(_ h: Heap<Int>) -> Bool {
    for i in 0..<h.count {
      let left = h.leftChildIdx(ofIdx: i)
      let right = h.rightChildIdx(ofIdx: i)
      let parent = h.parentIdx(ofIdx: i)
  ...
  public func isPermutation(_ array1: [Int], _ array2: [Int]) -> Bool {
    var a1 = array1
    var a2 = array2
  ...
  func testInsertArrayAndRemove() {
    var heap = Heap<Int>(array: [1, 3, 2, 7, 5, 9], sort: >)
